...
const DEFAULT_STATE = {
  ...
  dailyQuests: [
    ...
    { id: 'dq8', name: 'Estiramientos matutinos', exp: 15, stat: 'VIT', type: 'daily', completed: false, streakDays: 0 },
    { id: 'dq9', name: 'Leer o estudiar 30+ min', exp: 35, stat: 'INT', type: 'daily', completed: false, streakDays: 0 },
    { id: 'dq10', name: 'Tender la cama al levantarse', exp: 10, stat: 'SEN', type: 'daily', completed: false, streakDays: 0 },
    { id: 'dq11', name: 'Preparar ropa para el día siguiente', exp: 10, stat: 'SEN', type: 'daily', completed: false, streakDays: 0 },
    { id: 'dq12', name: 'Planificar tareas del día', exp: 20, stat: 'INT', type: 'daily', completed: false, streakDays: 0 },
    { id: 'dq13', name: 'Lavar los platos después de comer', exp: 15, stat: 'SEN', type: 'daily', completed: false, streakDays: 0 },
  ],

  // ── Class Missions (reset weekly, goal: 3/week) ──
  classMissions: [
    { id: 'cm1', name: 'Sesión de estudio', exp: 40, stat: 'INT', type: 'class', completedThisWeek: 0 },
    ...
    { id: 'cm4', name: 'Leer un capitulo de un libro', exp: 20, stat: 'INT', type: 'class', completedThisWeek: 0 },
    { id: 'cm5', name: 'Escribir resumen o notas de estudio', exp: 30, stat: 'INT', type: 'class', completedThisWeek: 0 }
  ],
  ...
  weeklyRaids: [
    ...
    { id: 'wr5', name: 'Orar', exp: 50,  stat: 'WIL', type: 'raid', completedThisWeek: false },
    { id: 'wr6', name: 'Journaling', exp: 70,  stat: 'INT', type: 'raid', completedThisWeek: false },
  ],
  ...
  negativeActions: [
    ...
    { id: 'na6', name: 'Desvelarse después de las 2 AM', penalty: { stat: 'VIT', amount: 2, statB: 'WIL', amountB: 1 }, expLoss: 20, type: 'negative' },
    { id: 'na7', name: 'Dormir menos de 5 horas', penalty: { stat: 'VIT', amount: 3, statB: 'INT', amountB: 2 }, expLoss: 35, type: 'negative' },
